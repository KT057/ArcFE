...
import { Dropdown002 } from "./index";

export default {
	title: "Basic/Dropdown/Product002",
	component: Dropdown002,
	tags: ["autodocs"],
} as Meta<typeof Dropdown002>;

const Template: StoryFn<typeof Dropdown002> = (args) => (
