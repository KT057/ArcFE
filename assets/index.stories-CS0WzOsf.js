import{d as s,l as T,r as C,j as t}from"./iframe-H3qRDz1v.js";import"./preload-helper-PPVm8Dsz.js";const m=s.div`
  ${({theme:e})=>e.font.baseSize.em()}
`,f=s.div.withConfig({shouldForwardProp:e=>e!=="hasError"})`
  position: relative;
  width: 100%;
`,g=s.textarea.withConfig({shouldForwardProp:e=>e!=="fontSize"&&e!=="lineHeight"&&e!=="color"&&e!=="backgroundColor"&&e!=="placeholderColor"&&e!=="inputType"})`
  width: 100%;
  display: block;
  border: 0;
